...
static const int64_t MAX_MONEY = 42048000 * COIN; //
...
public:
    ...
    {
        // Shijiancoin: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // Shijiancoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Shijiancoin: two types of block: proof-of-work or proof-of-stake
    ...
    // Shijiancoin: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Shijiancoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Shijiancoin: block index flags
    enum  
    {
