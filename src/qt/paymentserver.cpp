...
const QString BITCOIN_IPC_PREFIX("Shijiancoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Shijiancoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Shijiancoin: click-to-pay handler");
    else
...
{
    // clicking on Shijiancoin: URLs creates FileOpen events on the Mac:
